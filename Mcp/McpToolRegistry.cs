...
/// <summary>
/// MCP-style tool registry — declares every tool exposed to the LLM in /api/ai/assist.
/// Each entry maps to a callable tool; McpToolExecutor handles dispatch and execution.
/// </summary>
public static class McpToolRegistry
{
    ...
    /// <summary>All tools registered with the LLM for the /api/ai/assist endpoint.</summary>
